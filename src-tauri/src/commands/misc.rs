...
/// xAI's native installer stores its launcher and downloaded binaries below
/// `~/.grok`; use both the command path and canonical target because the
/// launcher may be a symlink.
